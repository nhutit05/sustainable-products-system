        ...
        <div className="flex-1 overflow-y-auto">
          <div className="grid gap-6 p-4 lg:p-6 xl:grid-cols-[1.7fr_1fr]">
            ...
            <div className="flex flex-col gap-6">
              <section className="flex min-h-[520px] items-center justify-center rounded-3xl border bg-gray-50 p-4 lg:min-h-[620px]">
                <div className="rounded-3xl bg-white p-4 shadow-xl lg:p-8">
                  <QRCode
                    value={qrCode}
                    size={window.innerWidth < 768 ? 260 : window.innerWidth < 1280 ? 340 : 430}
                  />
                </div>
              </section>
              ...
              <section className="rounded-3xl border bg-white p-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="rounded-2xl bg-emerald-50 px-5 py-3 text-center">
                    <p className="text-xs uppercase tracking-wider text-gray-500">Mã đơn</p>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div
                className={`rounded-3xl border p-5 transition-all ${paymentStatus === 'PAID' ? 'border-green-300 bg-green-50' : paymentStatus === 'EXPIRED' ? 'border-red-300 bg-red-50' : 'border-amber-300 bg-amber-50'}`}
              >
                <div className="flex items-center gap-3">
                  {paymentStatus === 'PAID' ? (
                    ...
                    <Clock3
                      className={paymentStatus === 'EXPIRED' ? 'text-red-600' : 'text-amber-600'}
                      size={28}
                    />
                  )}
