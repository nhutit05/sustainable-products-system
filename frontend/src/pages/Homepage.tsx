    ...
    <>
      <div className="page-cus_homepage mt-12">
        ...
        <section id="home" className="homepage_banner min-h-screen p-4 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto overflow-hidden px-4 sm:px-6 pt-16 sm:pt-24 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <aside className="homepage_banner_left text-left z-10">
              ...
              <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-green-900">
                Recycle.{' '}
              ...
              <p className="text-base sm:text-lg text-green-900/60 leading-relaxed my-6">
              ...
              <div className="homepage_banner-explore flex items-center gap-4 flex-wrap w-full">
                <a
                  href="#products"
                  className="inline-flex items-center gap-2 text-base sm:text-lg font-semibold px-5 sm:px-6 py-2.5 sm:py-3 shadow-lg text-white rounded-2xl bg-linear-to-r from-emerald-400 to-teal-600 hover:scale-105 hover:cursor-pointer transition-all duration-300"
                >
                ...
                <div
                  ...
                  className="inline-flex items-center gap-2 text-base sm:text-lg font-semibold px-5 sm:px-6 py-2.5 sm:py-3 shadow-lg text-green-900 rounded-2xl bg-white hover:scale-105 hover:cursor-pointer transition-all duration-300"
                >
        ...
        <section
          id="summary"
          className="homepage_summary mt-8 p-4 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 items-stretch max-w-7xl mx-auto"
        >
          {home_summary.map((itemSummary, index) => (
            <div
              className="item_summary text-left bg-linear-to-br from-[#F8FFF4] to-[#E8F5E9] border border-green-100 rounded-2xl p-4 sm:p-6 flex flex-col gap-2"
              key={index}
            >
              ...
              <div className="item_summary--content">
                <h2 className="text-sm sm:text-md text-green-900">{itemSummary.label}</h2>
        ...
        <section
          id="products"
          className="homepage_products min-h-screen p-4 relative overflow-hidden text-left max-w-7xl mx-auto mt-16 sm:mt-20"
        >
          <header className="relative flex flex-col gap-4">
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-emerald-400 p-3">MARKETPLACE</h2>
            ...
            <p
              className="text-base sm:text-lg text-emerald-600 font-medium leading-relaxed sm:absolute sm:bottom-0 sm:right-0 hover:text-emerald-400 hover:cursor-pointer transition-colors"
          ...
          <main className="products_list mt-8 sm:mt-12">
            {products.length > 0 ? (
              <div className="products_list--grid grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
