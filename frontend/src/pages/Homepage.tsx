                ...
                {products.map((product) => (
                  ...
                  >
                    ...
                    <div className="product_card--content p-3">
                      <h2 className="text-sm text-green-800 uppercase mb-2">
                      ...
                      <button className="product_card-btn text-white bg-linear-to-r from-emerald-400 to-teal-600 p-2 rounded-3xl mt-2 hover:from-emerald-500 hover:to-teal-600 hover:cursor-pointer w-full">
                        Xem chi tiết
                      </button>
                    </div>
                  </div>
